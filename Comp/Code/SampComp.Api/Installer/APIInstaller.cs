...
using ElmahCore.Mvc;
using ElmahCore;
using SampComp.Api.Filters;
using SampComp.Business.Installer;

namespace SampComp.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SampComp API", Version = version + "-" + branch});
            });
